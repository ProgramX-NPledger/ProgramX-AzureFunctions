...
public class PagedCosmosDbReader<T>
{
        ...
        int? itemsPerPage = null)
    {
        ...
        stopwatch.Stop();
        var pagedCosmosDbResult = new PagedCosmosDBResult<T>(items,continuationToken,itemsPerPage,requestCharge,(int)Math.Ceiling((double)totalCount / itemsPerPage ?? DataConstants.ItemsPerPage), stopwatch.Elapsed);
        ...
        int? itemsPerPage = DataConstants.ItemsPerPage)
    {
        ...
        var pagedCosmosDbResult = new PagedCosmosDBResult<T>(items,null,itemsPerPage,requestCharge,totalCount, stopwatch.Elapsed);
        return pagedCosmosDbResult;
    }
